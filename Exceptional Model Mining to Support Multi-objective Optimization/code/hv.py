...
class HyperVolume:
    ...
    def sortByDimension(self, nodes, i):
        ...
        # print(type(decorated[0]))
        # for x in decorated:
        #     if(x[0] == list(duplicates(lstval))[0]):
        #         decorated[cmpt] = (decorated[cmpt][0]-0.0000001,decorated[cmpt][1])
        #         break
        #     cmpt += 1 
        decorated.sort()
...
#     # Example:
#     referencePoint = [0.1, 0.1]
#     hv = HyperVolume(referencePoint)
#     front = [[3,2.5], [2.5,3]]
#     volume = hv.compute(front)
#     print(volume)
#     volume = volume/(referencePoint[0]*referencePoint[1])
#     print(volume)
